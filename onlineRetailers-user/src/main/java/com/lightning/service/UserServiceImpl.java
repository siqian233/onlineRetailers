...
import com.lightning.mapper.UserMapper;
import com.lightning.model.User;
import com.lightning.web.AuthRequest;
import com.lightning.web.AuthResponse;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDTO registerUser(UserDTO userDTO) {
        ...
        ResponseResult<List<String>> rr2 = this.fileUploadApi.upload(new MultipartFile[]{userDTO.getAvatarFile()});
        if (rr2.getCode() != 1) {
            throw new RuntimeException("上传头像失败");
        }
        List<String> avatarUrls = rr2.getData();
    ...
    public UserDTO updateUser(Long id, UserDTO userDTO) {
        ...
        // 允许更新用户名和角色，但通常不直接更新密码（密码有单独修改接口）
